...
import BookmarkButton from "@/app/(main)/_components/posts/bookmark-button";
import LikeButton from "@/app/(main)/_components/posts/like-button";
import PostMoreButton from "@/app/(main)/_components/posts/post-more-button";
...
function MediaPreviewList({ attachments }: MediaPreviewListProps) {
  return (
    <div
      className={cn(
        "flex flex-col gap-3",
...
function MediaPreview({ media }: MediaPreviewProps) {
  ...
  return <p className="text-destructive">Định dạng video không hỗ trợ</p>;
}
